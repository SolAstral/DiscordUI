...
function DiscordLib:Window(text)
	...
	MinimizeBtn.MouseEnter:Connect(function()
			...
			MinimizeBtn,
			TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{BackgroundColor3 = Color3.fromRGB(40, 43, 46)}
		):Play()
		end
	)
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		TweenService:Create(
			NotificationHolder,
			TweenInfo.new(1.4, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),
	...
	function DiscordLib:Notification(titletext, desctext, btntext)
		...
		Notification:TweenSize(UDim2.new(0, 346, 0, 176), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 1, true)
